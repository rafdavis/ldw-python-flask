...
import urllib
import json
import uuid # Biblioteca que cria um id único para algo
...
def init_app(app):
    ...
    @app.before_request
    def check_auth():
        # Rotas que não precisam de autenticação para serem acessado
    ...
    def galeria():
        ...
        if request.method == 'POST':
            ...
            file = request.files['file'] # Name do formulário
